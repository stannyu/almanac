          ...
          <div className="container">
            <div className={styles.grid}>
              <Link className={styles.card} to="/docs/CHANNEL">
                ...
                <p>
                  Positioning, tone, mission, and format for the educational
                  channel.
                </p>
              </Link>
              <Link className={styles.card} to="/docs/CODEX-COMMANDS">
                ...
                <p>
                  Reference for Codex CLI slash commands, grouped by topic and
                  workflow.
                </p>
              </Link>
              <Link className={styles.card} to="/docs/ai">
                ...
                <p>
                  Tooling notes including Codex, Copilot CLI, and Ghostty
                  shortcuts.
                </p>
              </Link>
              <Link className={styles.card} to="/docs/llm">
                ...
                <p>
                  RAG patterns, prompt hacking concepts, and model-oriented
                  documentation.
                </p>
              </Link>
            </div>
