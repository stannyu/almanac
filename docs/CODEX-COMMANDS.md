...
Reference for the built-in slash commands documented on the OpenAI page: [developers.openai.com/codex/cli/slash-commands](https://developers.openai.com/codex/cli/slash-commands).
